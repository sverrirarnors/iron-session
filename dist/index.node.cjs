...
// src/index.node.ts
var sealData = createSealData(crypto__default.default.webcrypto);
var unsealData = createUnsealData(crypto__default.default.webcrypto);
...
exports.getServerActionIronSession = getServerActionIronSession;
